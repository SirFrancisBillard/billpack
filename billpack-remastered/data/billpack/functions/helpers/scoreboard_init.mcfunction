...
scoreboard objectives remove ham_sand
scoreboard objectives remove ham_gravel
scoreboard objectives remove ham_netherrack
scoreboard objectives remove ham_andesite
scoreboard objectives remove ham_diorite
scoreboard objectives remove ham_granite
scoreboard objectives remove ham_endstone
...
scoreboard objectives add ham_sand minecraft.mined:minecraft.sand "Hammer Pickaxe: Sand Mined"
scoreboard objectives add ham_gravel minecraft.mined:minecraft.gravel "Hammer Pickaxe: Gravel Mined"
scoreboard objectives add ham_netherrack minecraft.mined:minecraft.netherrack "Hammer Pickaxe: Netherrack Mined"
scoreboard objectives add ham_andesite minecraft.mined:minecraft.andesite "Hammer Pickaxe: Andesite Mined"
scoreboard objectives add ham_diorite minecraft.mined:minecraft.diorite "Hammer Pickaxe: Diorite Mined"
scoreboard objectives add ham_granite minecraft.mined:minecraft.granite "Hammer Pickaxe: Granite Mined"
scoreboard objectives add ham_endstone minecraft.mined:minecraft.end_stone "Hammer Pickaxe: End Stone Mined"

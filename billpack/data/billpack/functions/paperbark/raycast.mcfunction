...
# Raycast loop if axe
execute as @e[tag=ray,limit=1,sort=nearest] at @s if entity @p[nbt={SelectedItem:{id:"minecraft:wooden_axe"}}] run function billpack:paperbark/raycast_loop
execute as @e[tag=ray,limit=1,sort=nearest] at @s if entity @p[nbt={SelectedItem:{id:"minecraft:stone_axe"}}] run function billpack:paperbark/raycast_loop
execute as @e[tag=ray,limit=1,sort=nearest] at @s if entity @p[nbt={SelectedItem:{id:"minecraft:iron_axe"}}] run function billpack:paperbark/raycast_loop
execute as @e[tag=ray,limit=1,sort=nearest] at @s if entity @p[nbt={SelectedItem:{id:"minecraft:golden_axe"}}] run function billpack:paperbark/raycast_loop
execute as @e[tag=ray,limit=1,sort=nearest] at @s if entity @p[nbt={SelectedItem:{id:"minecraft:diamond_axe"}}] run function billpack:paperbark/raycast_loop
...
scoreboard players set @s paperbark.wood 0
scoreboard players set @s paperbark.stone 0
scoreboard players set @s paperbark.iron 0
scoreboard players set @s paperbark.gold 0
scoreboard players set @s paperbark.dia 0
